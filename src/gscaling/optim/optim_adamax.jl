...
function _optim_adamax_method(;
    alpha::Float64 = 0.002,
    beta_mean::Float64 = 0.9,
    beta_var::Float64 = 0.999,
...
# =============================================================================
# 1. Original calibration with Optim.jl AdaMax
# =============================================================================

function calibrate_upsilon_optim_adamax_ddfactplus(
    C,
    s::Int,
    t::Int;
    ...
    # AdaMax parameters.
    adamax_alpha::Float64 = 0.002,
    adamax_beta_mean::Float64 = 0.9,
    adamax_beta_var::Float64 = 0.999,
    adamax_epsilon::Float64 = 1e-8,
    ...
    method = _optim_adamax_method(
        alpha = adamax_alpha,
        beta_mean = adamax_beta_mean,
        beta_var = adamax_beta_var,
        epsilon = adamax_epsilon,
    )
    ...
    return run_upsilon_optim_ddfactplus(
        ...
        verbose = verbose,
        method_name = "Optim.AdaMax",
    )
end


# =============================================================================
# 2. Proximal operator subproblem with Optim.jl AdaMax
# =============================================================================

function solve_upsilon_prox_optim_adamax_ddfactplus(
    C,
