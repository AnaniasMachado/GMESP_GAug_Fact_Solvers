...
# =============================================================================
# 1. Original calibration with Optim.jl Adam
# =============================================================================

function calibrate_upsilon_optim_adam_ddfactplus(
    C,
    s::Int,
    t::Int;
    ...
    # Adam parameters.
    adam_alpha::Float64 = 0.0001,
    adam_beta_mean::Float64 = 0.9,
    adam_beta_var::Float64 = 0.999,
    adam_epsilon::Float64 = 1e-8,
    ...
    method = _optim_adam_method(
        alpha = adam_alpha,
        beta_mean = adam_beta_mean,
        beta_var = adam_beta_var,
    ...
    return run_upsilon_optim_ddfactplus(
        ...
        verbose = verbose,
        method_name = "Optim.Adam",
    )
end


# =============================================================================
# 2. Proximal operator subproblem with Optim.jl Adam
# =============================================================================

function solve_upsilon_prox_optim_adam_ddfactplus(
    C,
