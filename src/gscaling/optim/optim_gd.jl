...
function _optim_gradient_descent_method()
...
# =============================================================================
# 1. Original calibration with Optim.jl GradientDescent
# =============================================================================

function calibrate_upsilon_optim_gd_ddfactplus(
    C,
    s::Int,
    t::Int;
    ...
    method = _optim_gradient_descent_method()
    ...
    return run_upsilon_optim_ddfactplus(
        ...
        verbose = verbose,
        method_name = "Optim.GradientDescent",
    )
end


# =============================================================================
# 2. Proximal operator subproblem with Optim.jl GradientDescent
# =============================================================================

function solve_upsilon_prox_optim_gd_ddfactplus(
    C,
